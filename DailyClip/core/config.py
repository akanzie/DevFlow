...
class AppConfig:
    ...
    def get_screenshot_filename(timestamp: datetime) -> str:
        ...
        return (
            f"{AppConfig.SCREENSHOT_PREFIX}{timestamp:%H-%M-%S}"
            f"{AppConfig.SCREENSHOT_EXTENSION}"
        )
    ...
    def get_default_config() -> dict[str, Any]:
        ...
        return {
            ...
            "search": {
                ...
                "browse_limit": AppConfig.BROWSE_DEFAULT_LIMIT,
                "auto_refresh_ms": AppConfig.WORKSPACE_AUTO_REFRESH_MS,
            },
            "notes": {
